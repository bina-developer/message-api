...
<body>
    ...
    <a class="d-block py-1 px-2  bg-warning rounded" href="<?= url('logout') ?>">logout</a>
    </nav>

    <div class="container-fluid">
        <div class="row">
            <nav class="col-md-2 d-none d-md-block pt-3 bg-sidebar sidebar px-0">
                <a class="text-decoration-none d-block py-1 px-2 mt-1" href="<?= url('admin/content/message') ?>"><i class="fas fa-clipboard-list"></i>message</a>
            </nav>
